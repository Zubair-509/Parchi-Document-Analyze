            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-150 ${
                  isActive ? 'text-[var(--sage)]' : 'text-[var(--text-muted)]'
                }`
              }
              style={({ isActive }) =>
                isActive ? { background: 'rgba(90,138,110,0.18)' } : {}
              }
            >
              {({ isActive }) => (
                <>
        ...
        <div className="border-t p-4" style={{ borderColor: 'rgba(90,138,110,0.1)' }}>
          <div className="mb-3 flex items-center gap-3">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-bold text-[var(--cream)]"
              style={{ background: 'var(--sage)' }}>MA</div>
            <div className="min-w-0">
              <p className="truncate text-[13px] font-semibold text-[var(--cream)]">Muhammad Ali</p>
              <p className="truncate text-[11px] text-[var(--text-muted)]">ali@example.com</p>
            </div>
          </div>
